...
window.sendDataToServer = function(data) {
  data.canvas = String(data.canvas);
  data.webgl = String(data.webgl);
  data.webglInfo = String(data.webglInfo);
  console.log("Sending data:", data);
    return new Promise((resolve, reject) => {
        fetch(baseURL + "/collect_browser_data", {
            method: 'POST',
            headers: {
...
sendDataToServer(data).then(() => {
    document.getElementById("checkingBrowser").style.display = "none";
    location.reload();
});
